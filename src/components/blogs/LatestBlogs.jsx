...
const LatestBlogs = () => {
    return (
        <div>
            ...
            <span className="
                text-[1.2rem] sm:text-[1.3rem] lg:text-[1.2rem] xl:text-[1.3rem] 2xl:text-[1.4rem]
                ...
                {blogsData.slice(-3).reverse().map((blog, index) => {
                    return(
                        <Link href={`/blogs/${blog.slug}`} key={index} className="
                            ...
                            mb-[1rem] sm:mb-[0.9rem] lg:mb-[1rem] xl:mb-[1.1rem] 2xl:mb-[1.2rem]
                        ">
                            <div className="w-[21%]">
                            ...
                            <div className="w-[76%]">
                                ...
                                <p className="
                                    text-[1.1rem] sm:text-[1rem] lg:text-[0.9rem] xl:text-[1rem] 2xl:text-[0.9rem]
                                    mt-[0.5rem] sm:mt-[0.4rem] lg:mt-[0.3rem] xl:mt-[0.4rem] 2xl:mt-[0.5rem]
                                    text-[#6f6f6f]
                                ">
                                    {blog.desc}
                                </p>
