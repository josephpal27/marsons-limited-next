        ...
        <>
            <section>
                ...
                <div className="
                    ...
                    pt-[1rem] sm:pt-[2rem] lg:pt-[2rem] xl:pt-[2.5rem] 2xl:pt-[3rem]
                ...
                ">
                    ...
                    ">
                            ...
                            >
                                <h1 className="
                                    text-[2rem] sm:text-[4.8rem] lg:text-[6rem] xl:text-[7rem] 2xl:text-[8rem]
                                    text-[#e9202a] font-[700] leading-[0.9]
                                ">
                                    <span className="
                                        font-[300] text-[#000] inline-block
                                        text-[1.5rem] sm:text-[2.5rem] lg:text-[3rem] xl:text-[3.5rem] 2xl:text-[4rem]
                                    ">
                                        WHAT
                                    </span> <br /> WE DO
                                </h1>
                ...
                <div className="
                    relative
                    mt-[0] sm:mt-[1.5rem] lg:mt-[0.8rem] xl:mt-[0.9rem] 2xl:mt-[1rem]
                ...
                ">
                    ...
                    <div className="
                        lg:w-[35%]
                        lg:absolute
                        top-[0] sm:top-[2rem] lg:top-[2rem] xl:top-[2.5rem] 2xl:top-[3rem]
                        right-[7%]
                        px-[1rem] sm:px-[5%] lg:px-0
                        py-[1.5rem] sm:py-0
                    ">
                        <Reveal>
                            <span className="
                        ...
                        <Fade>
                            <p className="
                                text-[1rem] sm:text-[1.1rem] lg:text-[0.9rem] xl:text-[1rem] 2xl:text-[1.1rem]
                                mt-[0.5rem] sm:mt-[0.6rem] lg:mt-[0.8rem] xl:mt-[0.9rem] 2xl:mt-[1rem]
                                text-[#000] font-[500]
                            ">
